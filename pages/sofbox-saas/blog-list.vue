<template>
  <div>
    <BlackBannerStyle1 title=" All Blogs">
    ...
    <div class="main-content">
      <section class="iq-blogs">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <BlogListing sm="12" md="6" lg="6" :bloglists="blogList" />
            </div>
          </div>
          <BlackPagination
            :next-url="pagination.next_link"
            :previous-url="pagination.previous_link"
            :first-url="pagination.first_link"
            :last-url="pagination.last_link"
